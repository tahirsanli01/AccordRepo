...
namespace ScreenCapture.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to An error occurred while trying to capture audio from {0}. This may be an indication that the device is already in use or is unavailable. If you have selected multiple devices, it could be possible your system does not support the selected configuration. 
        ///
        ///Please try de-selecting the device from the audio capture options..
        /// </summary>
        internal static string Error_Audio_Source {
            get {
                return ResourceManager.GetString("Error_Audio_Source", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to An error occurred when trying to capture video from {0}. This may be an indication that the device is already in use or unavailable..
        /// </summary>
        internal static string Error_Video_Source {
            get {
                return ResourceManager.GetString("Error_Video_Source", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Perhaps you would like to know that this software is more useful if you enable always-visible notification icons for it..
        /// </summary>
